	...
	sim(sim_)
{
	...
	ui::Label* messageLabel = new ui::Label(ui::Point(4, -35), ui::Point(Size.X - 8, 14), "Edit property");
	messageLabel->SetTextColour(style::Colour::InformationTitle);
	messageLabel->Appearance.HorizontalAlign = ui::Appearance::AlignLeft;
	messageLabel->Appearance.VerticalAlign = ui::Appearance::AlignTop;
	AddComponent(messageLabel);

	ui::Button* okayButton = new ui::Button(ui::Point(0, Size.Y - 57), ui::Point(Size.X, 17), "OK");
	...
	property = new ui::DropDown(ui::Point(8, -15), ui::Point(Size.X - 16, 16));
	...
	textField = new ui::Textbox(ui::Point(8, 6), ui::Point(Size.X - 16, 16), "", "[value]");
...
void PropertyWindow::OnDraw()
{
	...
	g->clearrect(Position.X - 2, Position.Y - 42, Size.X + 3, Size.Y + 3);
	g->drawrect(Position.X, Position.Y - 40, Size.X, Size.Y, 200, 200, 200, 255);
}
